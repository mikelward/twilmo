...
dependencies {
    ...
    // Arrives with the config store (TODO.md Phase 2): endpoint + identity
    // persistence that rides platform backup; the secret is stored
    // separately, encrypted, and backup-excluded.
